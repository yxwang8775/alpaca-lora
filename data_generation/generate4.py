...
lora_weights='/nvme/wangyaoxiang/model/lora-alpaca'

components = {
    "{instruction}": f"This is a conversation. Bob and Alice are playing a game. Alice have a number between 0 and 100. Bob has to guess it. Bob guess a number each time and then Alice will tell him \"Too low\" or\"Too high\".",
    "{input}": f"Alice: I'm thinking of a number between {low} and {high}. You have to guess it. Just give me a number.",
    "{output}": ""}
...
target = 13
t_options = [f"Alice: Too low. Guess again.\nBob:",
             f"Alice: Too high. Guess again.\nBob:",
